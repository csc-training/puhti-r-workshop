...
Several further examples on running serial and parallel R jobs using the packages `snow`, `parallel` and `future` for the analysis of spatial data can be found [in this repository](The https://github.com/csc-training/geocomputing/tree/master/R/puhti).
